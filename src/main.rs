...
fn main() {
    ...
    let destination_mask = "24"; // string literal, already type &str, or string refrence
    ...
    println!("Packetdesitnation ip: {}, mask: {}", packet.destination_ip, packet.destination_mask);
}
